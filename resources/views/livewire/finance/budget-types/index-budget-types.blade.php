<div>
    @livewire('finance.budget-types.create-budget-type')
    <x-slot name="header">
    ...
    <div class="block justify-between items-center p-4 mx-4 mt-4 mb-6 bg-white dark:bg-slate-800 rounded-2xl shadow-xl shadow-gray-200 dark:shadow-gray-900 lg:p-5 sm:flex">
        <div class="mb-1 w-full">
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-300 sm:text-2xl">All budgetTypes</h1>
            </div>
                ...
                <form class="mb-4 sm:pr-3 sm:mb-0" action="#" method="GET">
                    ...
                    <div class="relative mt-1 sm:w-64 xl:w-96">
                        <input type="text" name="email" id="products-search"
                            ...
                            placeholder="Search for budgetTypes" wire:model="search">
                    </div>
                </form>
                            ...
                            @foreach ($budgetTypes as $item)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                                        <button type="button" data-modal-toggle="product-modal" wire:click="$emit('editBudgetType', {{$item->id}})"
